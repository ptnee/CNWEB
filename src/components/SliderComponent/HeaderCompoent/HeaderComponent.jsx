...
const HeaderComponent = ({ isHiddenSearch = false, isHiddenCart = false }) => {
  ...
  return (
    <div style={{  heiht: '100%', width: '100%', display: 'flex',background: '#e11b1e', justifyContent: 'center' }}>
      <WrapperHeader style={{ justifyContent: isHiddenSearch && isHiddenSearch ? 'space-between' : 'unset' }}>
        <Col span={5}>
          <WrapperTextHeader to='/'>BKMOBILE SHOP</WrapperTextHeader>
        </Col>
        {!isHiddenSearch && (
          <Col span={13}>
            <ButttonInputSearch
              ...
              onChange={onSearch}
              backgroundColorButton="hsla(0,0%,100%,.2)"
            />
          </Col>
        )}
